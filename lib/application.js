...
// koa-convert 将Koa旧版（0.x和1.x）生成器中间件转换为现代的Promise中间件（2.x）
// 它还可以将现代的Promise中间件转换回传统的生成器中间件（有助于现代中间件支持Koa v0.x或v1.x）
...
module.exports = class Application extends Emitter {
  ...
  createContext(req, res) {
    // 创建上下文 context 并封装下request、response
